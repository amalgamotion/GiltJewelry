...
<div id="wrapper">
  ...
  <div id="header">
    ...
    <div id="header_top">
      ...
      <div>
      	<a href="/"><?php /*?><img src="<?php print $base_path; ?><?php print $directory; ?>logo.png" /><?php */?><img src="../images/logo.png" /></a>
      </div>
    
    <div id="nav">
    	Home  |  Vintage Gallery  |  Artisan Gallery  |  Wedding & Engagement  |  Reviews & Accolades  |  Gilt Gab  |  Find Us  |  Contact
    </div>
  ...
  <div id="footer_mid">
    ...
    720 NW 23rd Avenue &#183; Portland, OR 97210 &#183; (503) 226-0629
  </div>
  
  <div id="footer_bottom">
  	<?php print render($page['footer_bottom']); ?>
   Privacy Policy | Terms of Use | Conditions of Sale | Care & Guarantee | Ring Size Tools | Favorite Links | Contact Us
  </div>
