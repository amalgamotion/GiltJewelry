...
<div id="wrapper">
	<div id="header">
		<div id="header_top">
			...
			<!--Login  |  Search
			<input name="textfield" type="text" id="textfield" size="27" />-->
			</div>
			<div id="search"><?php print render($page['search']) ?></div>
		  
			<div id="right"> <?php print render($page['top_right']) ?>
			<!--Wish List  |  Jewel Box ( 0)  |  Checkout-->
			</div>
		</div>
		<div><a href="/"><img src="../../../../Documents and Settings/IF14/Local Settings/Temp/fz3temp-1/<?php print $base_path; ?><?php print $directory; ?>/images/logo.png" /></a></div>
		<?php if ($main_menu): ?>
	...
	<div id="main" class="jewel_cnttype">
	...
	<div id="footer_wrapper">
		...
		<div id="footer_mid">
			...
			720 NW 23rd Avenue &#183; Portland, Oregon 97210 &#183; 503-226-0629
		</div>
